...
do documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=163 height=13>N<u>o</u> 
...
<img height=13 src=Boletos/imagens/1.png width=1 border=0></td><td class=ct valign=top width=72 height=13>Data 
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  ...
  </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top width=163 height=12> 
    <span class="campo">
    <?php echo $dadosboleto["numero_documento"]?>
    </span></td>
 ...
 </div></td><td class=cp valign=top width=7 height=12><img height=12 src=Boletos/imagens/1.png width=1 border=0></td><td class=cp valign=top  width=72 height=12><div align=left> 
   <span class="campo">
...
<img height=1 src=Boletos/imagens/2.png width=7 border=0></td><td valign=top width=163 height=1><img height=1 src=Boletos/imagens/2.png width=163 border=0></td><td valign=top width=7 height=1> 
