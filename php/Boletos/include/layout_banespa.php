...
<BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="Boletos/imagens/logobanespa.jpg"
      border=0></span></td>
...
Valor documento</td></tr><tr> <td class=cp valign=top width=7 height=12><img height=12 src="Boletos/imagens/1.png" width=1 border=0></td><td valign=top class=cp height=12 COLSPAN="3"><div align=left><?=$dadosboleto["nome_da_agencia"]?>
