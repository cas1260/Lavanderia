<?php
	...
	if ($txtdatainicial != '') {
		...
		$sql = "select distinct a.id as idromanei, a.os, b.codigo, b.nome as cliente, b.fantasia, b.doc, a.valortotal as valor, a.entrada as data from tblromanei a 
...
detalheos<?php echo $namespace;?> = function(){
	...
	varOS = Ext.getCmp('<?php echo $namespace?>gridsimples').getSelectionModel().getSelected().data.os;
	window.open('./php/wb_print_romanei.php?print=false&os='+varOS, "_new");
}
